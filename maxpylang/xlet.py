...
class Inlet:
    ...
    def __init__(
        ...
        parent: "MaxObject",
        index: int,
        sources: Optional[list["Outlet"]] = None,
        midpoints: Optional[list[Any]] = None,
        types: Any = None,
    ) -> None:
    ...
    def __repr__(self) -> str:
        ...
        for source in self._sources:
            ...
            if self._midpoints[self._sources.index(source)] is not None:
                rep += ", midpoints: " + str(
                    self._midpoints[self._sources.index(source)]
                )
...
class Outlet:
    ...
    def __init__(
        ...
        parent: "MaxObject",
        index: int,
        destinations: Optional[list[Inlet]] = None,
        types: Any = None,
    ) -> None:
        self._parent = parent  # parent MaxObject
    ...
    def __repr__(self) -> str:
        ...
        for destination in self._destinations:
            rep += (
                "\n\tdestination: "
                + destination._parent._name
                + ": inlet "
                + str(destination._index)
            )
            if destination._midpoints[destination._sources.index(self)] is not None:
                rep += ", midpoints: " + str(
                    destination._midpoints[destination._sources.index(self)]
                )
